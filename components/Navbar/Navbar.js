  ...
  return (
    <>
      ...
      <div className={styles.flashBanner}>
        <span>🔥 FLASH SALE – Up to 30% OFF on Selected Items!</span>
        ...
        <div className={styles.container}>
          ...
          <Link href="/" className={styles.logo}>
            <div className={styles.logoImg}>
              <Image src="/logo.png" alt="MEER EMPIRE" width={50} height={50} priority />
            </div>
            <div className={styles.logoText}>
              <span className={styles.logoMain}>MEER</span>
              <span className={styles.logoSub}>EMPIRE</span>
            </div>
          </Link>
          ...
          <div className={styles.actions}>
            ...
            <button className={styles.hamburger} onClick={() => setMobileOpen(!mobileOpen)} aria-label="Menu">
              <span className={`${styles.ham} ${mobileOpen ? styles.open : ''}`}></span>
            </button>
          </div>
        </div>
